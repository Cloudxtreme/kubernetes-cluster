...
cp kubernetes-worker0.pem ../kubernetes-worker0/ssl/worker-key.pem
...
cp kubernetes-worker1.pem ../kubernetes-worker1/ssl/worker-key.pem
...
cp kubernetes-worker2.pem ../kubernetes-worker2/ssl/worker-key.pem
